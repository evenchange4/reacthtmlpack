...
function buildToDir(destDir, srcPatternList) {
  ...
  var publishedWebpackConfigArrayStream = createWebpackConfigArray(entryListFileStream).publish();

  var webpackConfigFilepathByIndexStream = createWebpackConfigFilepathByIndex(publishedWebpackConfigArrayStream);

  var webpackSingleStatsArrayStream = publishedWebpackConfigArrayStream.map(function (webpackConfigArray) {
...
function devServer(relativeDevServerConfigFilepath, destDir, srcPatternList) {
  ...
  var publishedWebpackConfigArrayStream = createWebpackConfigArray(entryListFileStream, devServerConfigFilepath).publish();
