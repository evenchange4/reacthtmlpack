...
exports.indexFilepathMapAndSingleStatsArrayCombiner = indexFilepathMapAndSingleStatsArrayCombiner;
...
function indexFilepathMapAndSingleStatsArrayCombiner(filepathByIndex, singleStatsArray) {
...
function entryListFileAndFilepathWebpackStatsMapCombiner(entryListFile, webpackStatsByFilepath) {
  return _extends({}, entryListFile, {
    entryList: null,
    outputAssetListByChunkName: entryListFile.entryList.reduce(function (acc, _ref3) {
      ...
      return _extends({}, acc, _defineProperty({}, chunkName, outputAssetList));
    }, {})
  });
}
